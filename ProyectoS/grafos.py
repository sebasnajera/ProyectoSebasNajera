...
class Application(Frame):
    def __init__(self, master=None):
        ...
        self.largura = Button(self, text="Busca en Largura", comman=aplica_largura)
        self.profundidade = Button(self, text="Busca en Profundidades", command=aplica_profundidade)
        self.dijkstra = Button(self, text="Caminos mínimos - Dijkstra", command=aplica_dijkstra)
        self.coloracao = Button(self, text="Colocacion de vértices - Welsh & Powell", command=aplica_coloracao)
        self.todos = Button(self, text="Exportar todas las transformaciones", command=aplica_todos)
        ...
        self.pack()
app = Application()
app.master.title("Algoritmos en Grafos")
